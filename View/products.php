    ...
    <section class="products product-list">
        <div class="product-card">
            <a href="https://www.exemplo.com/iphone12" class="product-link">
        ...
        <div class="product-card">
            <a href="https://www.exemplo.com/perfume" class="product-link">
        ...
        <div class="product-card">
            <a href="https://www.exemplo.com/tenis" class="product-link">
        ...
        <div class="product-card">
            <a href="https://www.exemplo.com/relogio" class="product-link">
